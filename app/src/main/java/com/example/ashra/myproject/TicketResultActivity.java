...
import com.example.ashra.myproject.Modle.MyApplication;
import com.example.ashra.myproject.Modle.TicketView;
...
public class TicketResultActivity extends AppCompatActivity {
    ...
    private void searchBarcode(String barcode) {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                URL + barcode, null, new com.android.volley.Response.Listener<JSONObject>() {
            @Override
